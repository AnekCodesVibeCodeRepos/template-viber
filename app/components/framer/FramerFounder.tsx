    ...
    <section className="relative overflow-hidden border-b border-white/5 bg-[#04070d] py-24" id="founder-note">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 text-center">
        ...
        <h3 className="mb-10 text-2xl font-medium leading-relaxed tracking-tight text-white/40 sm:text-3xl">
          We find what to{" "}
          <span className="italic text-[#d5dbe6]">automate</span>, who your
          users are, and how to scale your business with AI.
        </h3>
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-white/40">Co-founder & AI Strategy Lead</p>
        </div>
      </div>
    </section>
  );
