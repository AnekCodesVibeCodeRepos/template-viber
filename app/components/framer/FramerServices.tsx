  ...
  const services = [
    {
      ...
      description: "We help you streamline internal operations by automating manual workflows, saving time and reducing human error.",
      icon: (
    ...
    },
    {
      ...
      description: "Analyze customer behavior in real time with machine learning models built specifically for your business needs.",
      icon: (
        <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      title: "Smart Chatbot Deployment",
      description: "Deploy intelligent chatbots that handle customer queries 24/7, reducing support load and improving satisfaction.",
      icon: (
        <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: "Leverage historical data and AI models to forecast trends, demand, and business outcomes with high accuracy.",
      icon: (
        <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        ...
        <div className="mb-16 flex flex-col items-center text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#04070d] px-4 py-1.5">
            ...
            <span className="text-xs font-medium uppercase tracking-[0.12em] text-white/70">Services</span>
          </div>
          <h2 className="mb-4 text-3xl font-bold tracking-tight text-[#d5dbe6] sm:text-4xl lg:text-5xl">
            Smarter Services, <span className="italic font-normal">Built with AI</span>
          </h2>
